...
OriginalAnimations = {
    ["Idle"] = {
        ...
        ["Aura"] = {"110211186840347", "114191137265065"}
    },
    ["Walk"] = {
        ["Geto"] = "85811471336028",
        ["Aura"] = "83842218823011",    
...
function setAnimation(animationType, animationId)
    ...
    local success, err = pcall(function()
        ...
        elseif animationType == "Jump" then
            lastAnimations.Jump = animatronic
            ResetJump()
